...
import importedIndexCode from '@/../node_modules/@rnr-method/hooks/src/index.ts?raw';
import importedUseAugmentedRefCode from '@/../node_modules/@rnr-method/hooks/src/useAugmentedRef.tsx?raw';
import importedUseControllableStateCode from '@/../node_modules/@rnr-method/hooks/src/useControllableState.tsx?raw';
import importedUseRelativePositionCode from '@/../node_modules/@rnr-method/hooks/src/useRelativePosition.tsx?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @rnr-method/hooks
    ```
...
```tsx
import { useRelativePosition } from '@rnr-method/hooks';
import type { PositionedContentProps, SlottablePressableProps, ViewRef } from '@rnr-method/types';
