...
import importedCode from '@/../node_modules/@rnr-method/utils/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @rnr-method/utils
    ```
  </TabItem>
...
```tsx
import { ToggleGroupUtils } from '@rnr-method/hooks';
...
```tsx
import { EmptyGestureResponderEvent } from '@rnr-method/hooks';
import type { PressableRef, SlottablePressableProps } from '@rnr-method/types';
