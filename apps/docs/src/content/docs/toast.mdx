...
import importedCode from '@/../node_modules/@rnr-method/toast/src/toast.tsx?raw';
import importedTypesCode from '@/../node_modules/@rnr-method/toast/src/types.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @rnr-method/toast
    ```
...
import { Portal } from '@rnr-method/portal';
import * as ToastPrimitive from '@rnr-method/toast';
