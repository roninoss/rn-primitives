...
import importedNativeCode from '@/../node_modules/@rnr-method/select/src/select.tsx?raw';
import importedWebCode from '@/../node_modules/@rnr-method/select/src/select.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@rnr-method/select/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@rnr-method/select/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @rnr-method/select
    ```
