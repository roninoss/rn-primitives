...
import importedNativeCode from '@/../node_modules/@rnr-method/hover-card/src/hover-card.tsx?raw';
import importedWebCode from '@/../node_modules/@rnr-method/hover-card/src/hover-card.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@rnr-method/hover-card/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@rnr-method/hover-card/src/index.ts?raw';
...
<Tabs>
  ...
  Install the component via your command line.
    ...
    ```bash
    npx expo install @rnr-method/hover-card
    ```
